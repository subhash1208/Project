...
CREATE TABLE IF NOT EXISTS ${__BLUE_MAIN_DB__}.emi_base_tm_tf_excp_mssd_pnch(
clndr_wk_cd STRING,
clnt_obj_id STRING,
cmpny_cd STRING,
db_schema STRING,
...
INSERT OVERWRITE TABLE ${__BLUE_MAIN_DB__}.emi_base_tm_tf_excp_mssd_pnch PARTITION(environment)
SELECT 
    /*+ COALESCE(800) */
    clndr_wk_cd,
    clnt_obj_id,
...
(SELECT
    ...
    ext.environment,      
    obs.mnth_cd
FROM ${__RO_BLUE_RAW_DB__}.dwh_t_fact_tm_mssd_pnch ext
LEFT OUTER JOIN (
    SELECT
      environment,
      --db_schema,
