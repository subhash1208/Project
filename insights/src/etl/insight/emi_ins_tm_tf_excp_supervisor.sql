SELECT 
    ...
    -- facts
    tm_supvr.exception_hours,
    tm_supvr.exception_count,
    cast(tm_supvr.exception_count as double) as  exception_count_events,
...
FROM
    ${hiveconf:__GREEN_MAIN_DB__}.emi_cube_tm_tf_excp_supervisor tm_supvr
    LEFT OUTER JOIN 
