SELECT 
    ...
    -- facts
    tm_prac.edits_count,
    cast(tm_prac.edits_count as double) as edits_count_events,
...
FROM
    ${hiveconf:__GREEN_MAIN_DB__}.emi_cube_tm_tf_edits_practitioner tm_prac
...
WHERE 
    ...
    AND (
        ...
        -- (
            ...
            AND cast(tm_prac.yr_cd as int) >= date_format(add_months(current_date, -24), 'yyyy') 
        -- )
    )