SELECT 
    ...
    -- facts
    tm_supvr.absence_ratio,
    cast(tm_supvr.absence_hrs_event_count as double) as absence_ratio_events,
    --tm_supvr.leave_ratio,
    tm_supvr.overtime_ratio,
    cast(tm_supvr.ot_hrs_event_count as double) as overtime_ratio_events,
    --tm_supvr.total_hrs,    
...
FROM
    ${hiveconf:__GREEN_MAIN_DB__}.emi_cube_tm_tf_supervisor tm_supvr
LEFT OUTER JOIN 
...
--AND tm_supvr.yr_wk_cd <=> maxhc.yr_wk_cd
